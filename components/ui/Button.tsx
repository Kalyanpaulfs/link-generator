...
export function Button({
    ...
    const baseStyles = "inline-flex items-center justify-center font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none rounded-lg tracking-tight";
    ...
    const variants = {
        ...
        outline: "bg-transparent text-gray-700 hover:bg-gray-50 border border-gray-300 focus:ring-gray-500",
